...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _base = __webpack_require__(335);

	var _base2 = _interopRequireDefault(_base);

	var _timer = __webpack_require__(337);

	var _timer2 = _interopRequireDefault(_timer);

	var _Calculate = __webpack_require__(338);

	var _Calculate2 = _interopRequireDefault(_Calculate);

	var _interface = __webpack_require__(339);

	var _interface2 = _interopRequireDefault(_interface);

	var _jquery = __webpack_require__(336);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }(); //玩法提示，中间逻辑，
	    ...
	    _createClass(Base, [{
	        ...
	        value: function initPlayList() {
	            this.play_list.set('r2', {
	                bonus: 6,
	                tip: '从01~11中任选2个或多个号码，所选号码与开奖号码任意两个号码相同，即中将<em class="red">6</em>元',
	                name: '任二'
	            }).set('r3', {
	                bonus: 19,
	                tip: '从01~11中任选3个或多个号码，所选号码与开奖号码任意三个号码相同，即中将<em class="red">19</em>元',
	                name: '任三'
	            }).set('r4', {
	                bonus: 78,
	                tip: '从01~11中任选4个或多个号码，所选号码与开奖号码任意四个号码相同，即中将<em class="red">78</em>元',
	                name: '任四'
	            }).set('r5', {
	                bonus: 540,
	                tip: '从01~11中任选5个或多个号码，所选号码与开奖号码任意五个号码相同，即中将<em class="red">540</em>元',
	                name: '任五'
	            }).set('r6', {
	                bonus: 90,
	                tip: '从01~11中任选6个或多个号码，所选号码与开奖号码任意六个号码相同，即中将<em class="red">90</em>元',
	                name: '任六'
	            }).set('r7', {
	                bonus: 26,
	                tip: '从01~11中任选7个或多个号码，所选号码与开奖号码任意七个号码相同，即中将<em class="red">26</em>元',
	                name: '任七'
	            }).set('r8', {
	                bonus: 9,
	                tip: '从01~11中任选2个或多个号码，所选号码与开奖号码任意八个号码相同，即中将<em class="red">9</em>元',
	                name: '任八'
	            });
	            //set不允许重复，吻合
	        }
	        ...
	        value: function initNumber() {
	            for (var i = 1; i < 12; i++) {
	                this.number.add(('' + i).padStart(2, '0')); //padStart 补白
	            }
	        }
	    }, {
	        key: 'setOmit',
	        value: function setOmit(omit) {
	            ...
	            try {
	                for (var _iterator = omit.entries()[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	                    ...
	                    self.omit.set(index, item); //set 保证元素不重复
	                }
	                //将数据更新到页面上
	            } catch (err) {
	                _didIteratorError = true;
	        ...
	        value: function setOpenCode(code) {
	            var self = this;
	            self.open_code.clear(); //map set 都可以用clear(),只有这两种数据结构才有该方法
	            var _iteratorNormalCompletion2 = true;
	            var _didIteratorError2 = false;
	            var _iteratorError2 = undefined;
	            ...
	            try {
	                for (var _iterator2 = code.values()[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
	                    ...
	                    self.open_code.add(item); //set 开奖号码不重复用list
	                }
	            } catch (err) {
	                _didIteratorError2 = true;
	                _iteratorError2 = err;
	            ...
	            self.updateOpenCode && self.updateOpenCode.call(self, code); //若updateOpenCode存在就调用这个方法
	        }
	    }, {
	        ...
	        value: function changePlayNav(e) {
	            ...
	            (0, _jquery2.default)('.boll-list .btn-boll').removeClass('btn-boll-active'); //切换玩法时将，之前选定的号码清空
	            self.getCount();
	        }
	    }, {
	        key: 'assistHandle',
	        ...
	        value: function getName() {
	            return this.name; //当前彩票名称
	        }
	    }, {
	        key: 'addCode',
	        value: function addCode() {
	            var self = this;
	            var $acitve = (0, _jquery2.default)('.boll-list .btn-boll-active').text().match(/\d{2}/g);
	            var active = $acitve ? $acitve.length : 0;
	            var count = self.computeCount(active, self.cur_play);
	            if (count) {
	                self.addCodeItem($acitve.join(' '), self.cur_play, self.play_list.get(self.cur_play).name, count);
	            }
	        }
	    }, {
	        key: 'addCodeItem',
	        ...
	        value: function getCount() {
	            ...
	            var tpl = void 0;
	            var c1 = win1 < 0 && win2 < 0 ? Math.abs(win1) : win1; //可以改成Number
	        ...
	        value: function getRandom(num) {
	            var arr = [],
	                index = void 0;
	            var number = Array.from(this.number); //把集合转成真正的数组
	            while (num--) {
	    ...
	    _createClass(Timer, [{
	        ...
	        value: function countdown(end, update, handle) {
	            ...
	            if (now - end > 0) {
	                ...
	                var rest_time = end - now;
	                var px_d = 1000 * 60 * 60 * 24;
	                var px_h = 1000 * 60 * 60;
	                var px_m = 1000 * 60;
	                var px_s = 1000;
	                var d = Math.floor(rest_time / px_d);
	                var h = Math.floor((rest_time - d * px_d) / px_h);
	                var m = Math.floor((rest_time - d * px_d - h * px_h) / px_m);
	                var s = Math.floor((rest_time - d * px_d - h * px_h - m * px_m) / px_s);
	                var r = [];
	                if (d > 0) {
	                    r.push('<em>' + d + '</em>\u5929');
	                }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }(); //期号和时间从服务端中获取过来
	//投注以及获奖的号，都是交互通信的
